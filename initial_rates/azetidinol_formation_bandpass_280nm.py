...
# ## Azetidinol Formation with 280 nm bandpass filter
...
path_to_kinetic_data = 'azetidinol_formation/kinetic_json/bandpass_280/concentration_variation'
experiments = {}
...
experiments['04_150uM_280nm_bp_08302021']['initial_rate_parameters'] = {
    'piperidine_acetophenone': {
        'time_range': slice(0,len(experiments['04_150uM_280nm_bp_08302021']['time_points'])),
...
experiments['01_200uM_280nm_bp_08252021']['initial_rate_parameters'] = {
    'piperidine_acetophenone': {
        'time_range': slice(1,len(experiments['01_200uM_280nm_bp_08252021']['time_points'])),
        'reaction_percentage': 99
    },
    'tosic_acid': {
        'time_range': slice(1,len(experiments['01_200uM_280nm_bp_08252021']['time_points'])),
...
experiments['02_100uM_280nm_bp_08272021']['initial_rate_parameters'] = {
    'piperidine_acetophenone': {
        'time_range': slice(0,len(experiments['02_100uM_280nm_bp_08272021']['time_points'])),
        'reaction_percentage': 99
    },
    'tosic_acid': {
        'time_range': slice(0,len(experiments['02_100uM_280nm_bp_08272021']['time_points'])),
...
experiments['05_75uM_280nm_bp_09012021']['initial_rate_parameters'] = {
    'piperidine_acetophenone': {
        'time_range': slice(1,len(experiments['05_75uM_280nm_bp_09012021']['time_points'])),
        'reaction_percentage': 99
    },
    'tosic_acid': {
        'time_range': slice(0,len(experiments['05_75uM_280nm_bp_09012021']['time_points'])),
        'reaction_percentage': 99
    },
}
experiments['03_50uM_280nm_bp_08272021']['initial_rate_parameters'] = {
    'piperidine_acetophenone': {
        'time_range': slice(1,len(experiments['03_50uM_280nm_bp_08272021']['time_points'])),
        'reaction_percentage': 99
    },
    'tosic_acid': {
        'time_range': slice(0,len(experiments['03_50uM_280nm_bp_08272021']['time_points'])),
        'reaction_percentage': 99
    },
}
...
experiments['01_200uM_280nm_bp_08252021']['initial_concentrations'] = [200, 0]
experiments['03_50uM_280nm_bp_08272021']['initial_concentrations'] = [50, 0]
experiments['02_100uM_280nm_bp_08272021']['initial_concentrations'] = [100, 0]
experiments['05_75uM_280nm_bp_09012021']['initial_concentrations'] = [75, 0]
experiments['04_150uM_280nm_bp_08302021']['initial_concentrations'] = [150, 0]

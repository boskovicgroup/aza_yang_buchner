...
# ## Azetidinol Formation Dependence on Source Power
...
path_to_kinetic_data = 'azetidinol_formation/kinetic_json/wattage_variation'
experiments = {}
...
experiments['02_450W_200uM_08052021']['initial_rate_parameters'] = {
    'piperidine_acetophenone': {
        'time_range': slice(0,len(experiments['02_450W_200uM_08052021']['time_points'])),
...
experiments['01_150W_200uM_08052021']['initial_rate_parameters'] = {
    'piperidine_acetophenone': {
        'time_range': slice(0,len(experiments['01_150W_200uM_08052021']['time_points'])),
        'reaction_percentage': 99
    },
    'tosic_acid': {
        'time_range': slice(0,len(experiments['01_150W_200uM_08052021']['time_points'])),
...
experiments['03_225W_200uM_08232021']['initial_rate_parameters'] = {
    'piperidine_acetophenone': {
        'time_range': slice(0,len(experiments['03_225W_200uM_08232021']['time_points'])),
        'reaction_percentage': 99
    },
    'tosic_acid': {
        'time_range': slice(0,len(experiments['03_225W_200uM_08232021']['time_points'])),
...
experiments['04_375W_200uM_08202021']['initial_rate_parameters'] = {
    'piperidine_acetophenone': {
        'time_range': slice(1,len(experiments['04_375W_200uM_08202021']['time_points'])),
        'reaction_percentage': 99
    },
    'tosic_acid': {
        'time_range': slice(0,len(experiments['04_375W_200uM_08202021']['time_points'])),
        'reaction_percentage': 99
    },
}
...
for i in experiments:
    print(experiments[i]['initial_rates'])
...
experiments['02_450W_200uM_08052021']['power'] = [450, 0]
experiments['01_150W_200uM_08052021']['power'] = [150, 0]
experiments['01_200uM_08032021']['power'] = [300, 0]
experiments['03_225W_200uM_08232021']['power'] = [225, 0]
experiments['04_375W_200uM_08202021']['power'] = [375, 0]
...
power = [
    [numpy.divide(experiments[experiment_id]['power'][0],1)]
    for experiment_id in experiment_ids
]

[rate_constant, m_power] = compLeastSquaresRateLaw(power, initial_rates)
fit = [
    numpy.log(rate_constant) + numpy.log(c[0])*m_power
    for c in power
]

print(f"Light power order: {m_power}")
print(f"reaction rate constant: {rate_constant}")

plt.xlabel("Log (Conc.)") 
plt.ylabel("Log (Initial rate)") 
plt.plot(numpy.log(power), numpy.log(initial_rates), "-bo", linestyle='none')
plt.plot(numpy.log(power), fit, "-r")
plt.show()
